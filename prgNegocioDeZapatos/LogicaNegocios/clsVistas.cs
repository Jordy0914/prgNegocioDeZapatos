...
namespace LogicaNegocios
{
    ...
    //    public Boolean mInsertarVista(clsConexion cone, clsEntidadMenu pEntidadVista)
    //    {
    ...
    //    public Boolean mEliminarVista(clsConexion cone, clsEntidadMenu pEntidadVista)
    //    {
